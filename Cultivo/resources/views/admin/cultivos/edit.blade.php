    ...
    <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6">
            ...
            <div class="text-center mb-4">
                <div class="edit-header p-4 rounded-3 shadow-sm" style="background: linear-gradient(135deg, #28a745 0%, #20c997 100%);">
            ...
            <div class="card border-0 shadow-lg">
                <div class="card-body p-5">
                    ...
                    <form action="/admin/cultivos/{{ $cultivo->id }}" method="POST">
                        @csrf
                        @method('PUT')
